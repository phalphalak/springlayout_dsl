...
taken from {example.rb}[link:Phalphalak/springlayout_dsl/blob/master/example.rb] (see {screenshot here}[link:Phalphalak/springlayout_dsl/blob/master/example_frame.jpg]):
